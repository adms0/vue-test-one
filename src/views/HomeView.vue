<template>
  <main class="detail">
    <router-link :to="{name: 'Home'}" class="link">
      <svg class="back-icon" color="hsl(252, 94%, 67%)" viewBox="0 0 1024 1024"
    ...
    <div class="status-container">
      ...
      <div class="btn-container">
        <button class="btn btn-edit" v-if="invoice.status === 'Draft' || invoice.status === 'Pending'"
          @click="editInvoice">
          Edit
        </button>
        <button class="btn btn-delete" @click="deleteItem">Delete</button>
        <button class="btn btn-mark" v-if="invoice.status === 'Pending'" @click="markAsPaid">
          Mark as Paid
        </button>
      </div>
    </div>
    <div class="details">
      ...
      <div class="item-container">
        ...
        <p>Price</p>
        <p>Total</p>
        <div class="project-item" v-for="(item, index) in invoice.projects" :key="index">
