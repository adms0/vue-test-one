    ...
    <div class="filter" ref="filter">
      ...
      <div v-show="filterIsOpen" class="filter-body">
        <div class="filter-item">
          <input type="checkbox" name="draft" value="Draft" v-model="selectedFilter" />
          <label for="draft">Draft</label>
        </div>
        <div class="filter-item">
          <input type="checkbox" name="pending" value="Pending" v-model="selectedFilter" />
          <label for="pending">Pending</label>
        </div>
        <div class="filter-item">
          <input type="checkbox" name="paid" value="Paid" v-model="selectedFilter" />
