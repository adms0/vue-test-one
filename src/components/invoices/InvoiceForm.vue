    ...
    <div class="form-container" v-show="menuIsOpen">
      ...
      <form class="form">
        ...
        <div class="input-item">
          ...
          <input class="form__input" :class="{
            errorborder: $v.invoiceForm.adress.$error,
          }" v-model.trim="$v.invoiceForm.adress.$model" type="text" name="street" id="street" />
        </div>
        <div class="input-group">
          <div class="input-item">
            ...
            }" v-model.trim="$v.invoiceForm.city.$model" type="text" name="city" id="city" />
          </div>
          <div class="input-item">
            <label class="form__label" :class="{
            ...
            }" v-model.trim="$v.invoiceForm.postCode.$model" type="text" name="postCode" id="postcode" />
          </div>
          <div class="input-item">
            <label class="form__label" :class="{
            ...
            }" v-model.trim="$v.invoiceForm.country.$model" type="text" name="country" id="country" />
          </div>
        </div>
        <h3>Bill To</h3>
        <div class="input-item">
          ...
          }" v-model.trim="$v.invoiceForm.clientName.$model" type="text" name="clientName" id="name" />
        </div>
        ...
        <div class="input-item">
          ...
          }" v-model.trim="$v.invoiceForm.clientEmail.$model" type="email" name="clientEmail" id="client-email" />
        </div>
        ...
        <div class="input-item">
          ...
          }" v-model.trim="$v.invoiceForm.clientAdress.$model" type="text" name="clientStreet" id="client-street" />
        </div>
        ...
        <div class="input-group">
          <div class="input-item">
            ...
            }" v-model.trim="$v.invoiceForm.clientCity.$model" type="text" name="clientCity" id="client-city" />
          </div>
          <div class="input-item">
            <label class="form__label" :class="{
            ...
            }" v-model.trim="$v.invoiceForm.clientPostCode.$model" type="text" name="clientPostcode"
              id="client-postcode" />
          </div>
          <div class="input-item">
            <label class="form__label" :class="{
            ...
            }" v-model.trim="$v.invoiceForm.clientCountry.$model" type="text" name="clientCountry"
              id="client-country" />
          </div>
        </div>
        <div class="input-group">
        ...
        <div class="input-item">
          ...
          }" v-model.trim="$v.invoiceForm.projectDesc.$model" type="text" name="desc" id="desc" />
        </div>
        <div>
          <h2>Item List</h2>
          <div class="added-projects">
            <div class="project-labels" v-show="invoiceForm.projects.length > 0">
            ...
            <div v-for="(item, index) in invoiceForm.projects" :key="index" class="added-projects-info">
              ...
              <div class="">
                <svg class="project-delete" color="hsl(232, 23%, 61%)" viewBox="0 0 1024 1024"
                  style="stroke: currentcolor; fill: currentcolor" @click="deleteProject(index)">
                  <path
          ...
          <div class="input-group" id="project">
            <div class="input-item" id="project-name">
              ...
              }" v-model="projectItem.name" ref="nextInput" type="text" name="itemName" id="item-name" />
            </div>
            <div class="input-item" id="project-qty">
              <label for="quantity"> Qty. </label>
              <input v-model="projectItem.quantity" type="number" name="quantity" id="quantity" />
            </div>
            <div class="input-item" id="project-price">
              ...
              <input :class="{
                errorborder: $v.invoiceForm.projects.$error,
              }" v-model="projectItem.price" type="number" name="price" id="price" />
            </div>
